...
# Unzipped local model folder path
...
def get_structured_inference(text, confidence_threshold=0.75):
    ...
    # Predict without tracking gradients (keeps it fast on your CPU)
    with torch.no_grad():
        outputs = model(**inputs)
        logits = outputs.logits
        
    # Turn raw output scores into percentage probabilities
    ...
    # Sort predictions from highest confidence to lowest
...
# --- Local Command Line Interface Loop ---
if __name__ == "__main__":
    ...
    while True:
        ...
        # Run prediction and print the JSON block
